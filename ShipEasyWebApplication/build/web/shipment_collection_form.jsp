...
<%
    ...
    response.setHeader("Content-Disposition", "attachment; filename=\"shipment_collection_report.pdf\"");
    ...
    try {
        ...
        Paragraph title = new Paragraph("Shipment Collection Report");
        title.setAlignment(Element.ALIGN_CENTER);
        document.add(title);
        
        document.add(new Paragraph("\n"));
        document.add(new Paragraph("Shipper details"));
        document.add(new Paragraph("\n"));
        
        document.add(new Paragraph("Shipment ID (Tracking Code): " + shipment.getProduct().getTrackingCode()));
        document.add(new Paragraph("Shipper: " + shipment.getUser().getName().charAt(0) + " " + shipment.getUser().getSurname()));
        ...
        document.add(new Paragraph("\n"));
        document.add(new Paragraph("Shipper's Signature: __________________________"));
